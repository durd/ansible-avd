...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF2 | Vlan4094 | 10.255.1.68 | Port-Channel47 |
...
| Ethernet8 | DC1-LEAF2C_Ethernet48 | *trunk | *11-12,21-22,3401-3402 | *- | *- | 8 |
| Ethernet47 | MLAG_PEER_dc1-leaf2a_Ethernet47 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 47 |
| Ethernet48 | MLAG_PEER_dc1-leaf2a_Ethernet48 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 47 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet44 | P2P_LINK_TO_DC1-SPINE1_Ethernet4 | routed | - | 10.255.255.13/31 | default | 9216 | False | - | - |
| Ethernet45 | P2P_LINK_TO_DC1-SPINE2_Ethernet4 | routed | - | 10.255.255.15/31 | default | 9216 | False | - | - |
...
!
interface Ethernet8
   description DC1-LEAF2C_Ethernet48
   no shutdown
...
interface Ethernet47
   description MLAG_PEER_dc1-leaf2a_Ethernet47
   no shutdown
   channel-group 47 mode active
!
interface Ethernet48
   description MLAG_PEER_dc1-leaf2a_Ethernet48
   no shutdown
   channel-group 47 mode active
```
...
| Port-Channel8 | DC1-LEAF2C_Po47 | switched | trunk | 11-12,21-22,3401-3402 | - | - | - | - | 8 | - |
| Port-Channel47 | MLAG_PEER_dc1-leaf2a_Po47 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel47
   description MLAG_PEER_dc1-leaf2a_Po47
   no shutdown
   switchport
   switchport mode trunk
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.255.0.6 | enabled | Ethernet44 <br> Ethernet45 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
