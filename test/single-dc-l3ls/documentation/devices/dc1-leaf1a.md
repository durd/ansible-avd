...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | P2P_LINK_TO_DC1-LEAF2A_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | P2P_LINK_TO_DC1-LEAF2B_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.255.0.3 | enabled | Ethernet3 <br> Ethernet4 <br> Vlan4094 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
